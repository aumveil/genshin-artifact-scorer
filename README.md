...
| 文档 | 内容 |
| --- | --- |
| [圣遗物背景知识总结.md](圣遗物背景知识总结.md) | 圣遗物系统背景知识（词条类型、数值上下限等） |
| [圣遗物评分算法设计.md](圣遗物评分算法设计.md) | 三大算法的完整设计：公式、伪代码与定稿示例数据 |
| [圣遗物网页实现方案.md](圣遗物网页实现方案.md) | 网页实现方案：架构、模块划分与数据模型 |
